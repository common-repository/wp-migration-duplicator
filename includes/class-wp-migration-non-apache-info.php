...
if (!class_exists('Wt_Mgdb_Inform_Server_Secure')) {

	class Wt_Mgdb_Inform_Server_Secure
	{
		...
		public $plugin_title             = 'WebToffee WP Backup and Migration';
		...
		public function __construct($plugin)
		{
			...
			require_once WP_PLUGIN_DIR . '/wp-migration-duplicator/includes/class-wt-security-helper.php';
			if (!$this->wt_get_display_server_info() && class_exists('Wp_Migration_Duplicator_Security_Helper')) {
...
?>
			<div class="<?php echo $this->banner_css_class; ?> notice-warning notice is-dismissible">
				...
				<code>
					...
					location ~ ^/wp-content/webtoffee_migrations { deny all; }
				</code>
			<?php endif; ?>
			</p>
			</div>
