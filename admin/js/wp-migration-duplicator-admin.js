    ...
    var wt_mgdp_log_handler =
            {
                ...
                view_raw_log: function (log_file)
                {
                    ...
                    $.ajax({
                        url: wtMigratorObject.ajax_url,
                        data: {'action': 'wp_mgdp_populate_popup', _wpnonce: wtMigratorObject.nonce, 'history_action': 'view_log', 'log_file': log_file, 'data_type': 'json'},
                        type: 'post',
                        dataType: "json",
                        success: function (response)
                        {
    ...
    var wt_mgdp_feedback_handler =
            {
                Set: function ()
                {
                    ...
                    $('[name="wt-feedback-submit"]').click(function (e) {
                        ...
                        $.ajax({
                            url: wtMigratorObject.ajax_url,
                            data: {'action': 'wp_mgdp_populate_feedback', _wpnonce: wtMigratorObject.nonce, 'email': feedback_customer_email, 'message': feedback_customer_email_subject, 'file': file},
                            type: 'post',
                            dataType: "json",
                            success: function (response)
                            {
