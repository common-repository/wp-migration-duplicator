...
<div class="wt_backups_wrapper ">
    <div class="wt_backup_btn_wrapper postbox post-box-over-content">
        <div class="div_header" ><h3 class="div_head" ><?php esc_html_e('Export / Backup', 'wp-migration-duplicator'); ?></h3></div>
        <div class="vertical-center">
            <button name="wt_mgdp_export_click_btn" class="button button-primary backup_btn"style="font-size: 18px;"><?php esc_html_e('Export / Backup Now', 'wp-migration-duplicator'); ?></button></div>
        <p style="width: 330px !important;margin: 170px 22px 10px 25px !important;color: #adaaaa"><?php echo esc_html__('Quick export and use this backup file for migration.', 'wp-migration-duplicator'); ?></p>
    </div>
    <div class="text_label">
        <h3 style="margin-top: 90px;margin-left: -10px;"><?php esc_html_e('OR', 'wp-migration-duplicator'); ?></h3>
    </div>
    <div class="wt_backup_schedule_btn_wrapper postbox post-box-over-content">
        <div class="div_header" ><h3 class="div_head" ><?php esc_html_e('Backup Schedule', 'wp-migration-duplicator'); ?></h3></div>
        <div class="wt_buttom_arrange">
            ...
            <div style="width: 48%">
                <div class="btn_pos ">
                    <button name="wt_mgdp_schedule_export_btn" class="button button-primary backup_btn vertical-center" style ="font-size: 18px;"><?php esc_html_e('Schedule Backup', 'wp-migration-duplicator'); ?></button>
                </div>
                <div class="wt_mgdp_cron_current_time time_pos"><b><?php esc_html_e('Current Server Time:','wp-migration-duplicator'); ?></b> <span>--:--:-- --</span></div>
            </div>
...
<div class = "wt_backup_data" id ="wt_backup_data">
    <div style="display:flex"> <h2 style="width: 190px;"><span><?php esc_html_e('Configuration Options', 'wp-migration-duplicator'); ?></span></h2><h2 class="h2_wt"><span></span></h2> </div>
    <div class="postbox wt_widths post-box-over" id="export_class">
        <div class="wt-migrator-accordion-tab wt-migrator-accordion-exclude-settings" style="border-bottom:.5em;">
            <a  href="#"><?php echo esc_html__('What to Backup?', 'wp-migration-duplicator'); ?></a>
            <div class="wt-migrator-accordion-content" id='content-div' style ="border-top: 1px solid #E1E4E7; height: 378px; ">
                <p><?php esc_html_e('Here you can choose to backup the required data. Only the selected files will be backed up! To exclude the backup of any of the selected files, unselect the required.', 'wp-migration-duplicator'); ?></p>
...
<!--                                <input type="radio" option="backup_default" name="export_type_default" value="files_and_db" checked />
                                ...
                                <label>
                                    ...
                                    <span><?php echo esc_html__(' Wordpress Files', 'wp-migration-duplicator') ?></span>
                                </label><br><br><br><br></div>
                                </div>
                                <div class="exclude_files" style="width: 50% ; margin-left: 36px; margin-top: -14px; " >
                                    <h2><?php echo esc_html__('Select the Files to Backup', 'wp-migration-duplicator'); ?></h2>
                                    <div>
                                        <table id="datagrid">
                                            <!-- select all boxes -->
                                            <tr>
                        ...
                        <div id='btn-exp' style="height:30px">
                            <button name="wt_mgdp_export_click_btn" class="button button-primary" style="float:right;margin: 20px -22px;"><?php esc_html_e('Backup Now', 'wp-migration-duplicator'); ?></button>
        ...
        <div class = "wt_backup_schedule_data" id ="backup_schedule_class" style = "display:none">
            <h2 ><?php esc_html_e('Schedule Configuration', 'wp-migration-duplicator'); ?></h2>
            <div class="postbox wt_widths post-box-over" id="schedule_class">
                <div class="wt-migrator-accordion-tab wt-migrator-accordion-export-storage-settings">
                    <a href="#"><?php echo esc_html__('Schedule Automatic Backup Settings', 'wp-migration-duplicator'); ?></a>
                    <div class="wt-migrator-accordion-content" style ="border-top: 1px solid #E1E4E7;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style ="width: 224px;padding: 15px 5px;font-size: 15px;">
                                            <div style="margin-top: -32px;"><?php esc_html_e('Interval','wp-migration-duplicator'); ?></div></td><td style="padding: 15px 20px;">
                                            <div class="wt_mgdp_schedule_now_formrow">			
                                                <div class="wt_mgdp_schedule_now_interval_radio_block">
                                                    <label for="wt_mgdp_cron_interval_day"><input type="radio" id="wt_mgdp_cron_interval_day" name="wt_mgdp_cron_interval" value="day" <?php
                                                        ...
                                                        ?> > <?php esc_html_e('Every Day','wp-migration-duplicator'); ?></label>&emsp;&emsp;
                                                    ...
                                                    <label for="wt_mgdp_cron_interval_week"><input type="radio" id="wt_mgdp_cron_interval_week" name="wt_mgdp_cron_interval" value="week" <?php
                                                        ...
                                                        ?> > <?php esc_html_e('Every Week','wp-migration-duplicator'); ?></label>&emsp;&emsp;
                                                    <!-- <label for="wt_mgdp_cron_interval_biweek"><input type="radio" id="wt_mgdp_cron_interval_biweek" name="wt_mgdp_cron_interval" value="biweek"> <?php esc_html_e('Biweekly', 'wp-migration-duplicator'); ?></label> -->
                                            ...
                                            <div class="wt_mgdp_schedule_now_interval_sub_block wt_mgdp_schedule_custom_interval_block">
                                                <label><?php esc_html_e('Custom interval','wp-migration-duplicator'); ?></label>
                                                <input type="number" step="1" min="1" name="wt_mgdp_cron_interval_val" value="" placeholder="<?php esc_html_e('Interval in minutes.','wp-migration-duplicator'); ?>">
                                                <span class="wt-iew_form_help" style="margin-top:3px;"><?php esc_html_e('Recommended: Minimum 2 hour(120 minutes)','wp-migration-duplicator'); ?></span>
                                            </div>
                                            <div class="wt_mgdp_schedule_now_interval_sub_block wt_mgdp_schedule_day_block" style="line-height: 30px;">
                                                <label><?php esc_html_e('Which day?','wp-migration-duplicator'); ?></label><br>
                                            ...
                                            <div class="wt_mgdp_schedule_now_interval_sub_block wt_mgdp_schedule_date_block" style="margin-bottom: 10px;">
                                                <label><?php esc_html_e('Day of the Month?','wp-migration-duplicator'); ?></label>
                                                <select name="wt_mgdp_cron_interval_date">
                                                    <?php
                                                    for ($i = 1; $i <= 28; $i++) {
                                                        if ($date_value == $i) {
                                                            ?>
                                                            <option value="<?php echo esc_attr($i); ?>" selected><?php echo esc_html($i); ?></option>
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    ?>
                                                    <option value="last_day"><?php esc_html_e('Last day','wp-migration-duplicator'); ?></option>
                                                </select>
                                            </div>
                                                ...
                                                <div style="float:left">
                                                    <select name="wt_mgdp_cron_start_ampm_val">
                                                        ...
                                                        foreach ($am_pm as $apvl) {
                                                            if ($am_or_pm == $apvl) {
                                                                ?>
                                                                <option selected><?php echo esc_html($apvl); ?></option>
                                                                <?php
                                                            } else {
                                                                ?>
                        ...
                        <table><tr><td style ="width: 172px"><div style="margin-bottom: 105px; margin-left: 28px;font-size: 14px;"><label><?php esc_html_e('Export Content'); ?><label</label></div></td><td>
                                    <div style="padding-left: 105px; " >
                                        ...
                                        <label>
                                            ...
                                            <span><?php echo esc_html__('Files', 'wp-migration-duplicator') ?></span>
                                        </label><br><br><br><br>
                        ...
                        <div style="height: 35px;">
                            ...
                            <button name="wt_mgdp_schedule_btn" class="button button-primary" style="float:right;margin: 12px -19px;"><?php esc_html_e('Schedule', 'wp-migration-duplicator'); ?></button>
                            <button name="wt_schedule_cancel_btn" class="button button-secondary" style="float:right;position: relative;margin: 12px 35px;width: 77px;"><?php esc_html_e('Cancel', 'wp-migration-duplicator'); ?></button>
        ...
        <div class="postbox wt_widths post-box-over">
            <div class="wt-migrator-accordion-tab wt-migrator-accordion-export-storage-settings" >
                ...
                <div class="wt-migrator-accordion-content" style ="border-top: 1px solid #E1E4E7;">
                    <p style="font-size:13px;"><?php esc_html_e('Advanced backup options. Fill up the fields as per your server performance. For high performance servers, you can specify a greater data size and bigger number of database records and files. Each will be processed per request.', 'wp-migration-duplicator'); ?></p>

                    <table class="form-table" style="margin-left: 20px;">       
                        <tr>
                            <th style="width:400px;font-weight: 400">
                                <label for="dta_size"><?php esc_html_e('Data Size Limit per Request', 'wp-migration-duplicator'); ?></label>
                                <span class="wt-mgdp-tootip" data-wt-mgdp-tooltip="<?php esc_attr_e('The maximum data size in megabytes that the server will backup for every request. For servers with high performance, you can handle a  greater data size per request. Defaulted to 50 mb.', 'wp-migration-duplicator'); ?>"><span class="wt-mgdp-tootip-icon"></span></span>
                            </th>
                            <td>
                                <input type="number" name="data_size_per_req" id="data_size_per_req" placeholder="<?php esc_attr_e('50', 'wp-migration-duplicator'); ?>" value="<?php echo esc_attr($data_size_per_req); ?>" class="input-text text_width" /><?php esc_html_e(' mb', 'wp-migration-duplicator'); ?>
                            </td>
                        </tr>
                        <tr>
                            <th style="font-weight: 400">
                                <label for="db_record_per_req"><?php esc_html_e('Number of Database Records per Request', 'wp-migration-duplicator'); ?></label>
                                <span class="wt-mgdp-tootip" data-wt-mgdp-tooltip="<?php esc_attr_e('The number of database records that the server will backup for every request. With high performance servers, you can handle a greater number of records per request. Defaulted to 10000 records.', 'wp-migration-duplicator'); ?>"><span class="wt-mgdp-tootip-icon"></span></span>
                            </th>
                            <td>
                                <input type="number" name="db_record_per_req" id="db_record_per_req"  value="<?php echo esc_attr($db_record_per_req); ?>"  placeholder="<?php esc_attr_e('10000', 'wp-migration-duplicator'); ?>" class="input-text text_width" />
                            </td>
                        </tr>
                        <tr>
                            <th style="font-weight: 400">
                                <label for="file_per_req"><?php esc_html_e('Number of Files Process per Request', 'wp-migration-duplicator'); ?></label>
                                <span class="wt-mgdp-tootip" data-wt-mgdp-tooltip="<?php esc_attr_e('The number of files that the server will backup for every request. With high performance servers, you can handle a greater number of files per request. Defaulted to 1000 files.', 'wp-migration-duplicator'); ?>"><span class="wt-mgdp-tootip-icon"></span></span>
                            </th>
                            <td>
                                <input type="number" name="file_per_req" id="file_per_req"  value="<?php echo esc_attr($file_per_req); ?>"  placeholder="<?php esc_attr_e('1000', 'wp-migration-duplicator'); ?>"class="input-text text_width" />
                            </td>
                        </tr>
                    </table>
                    <div style="height:30px">
                        <button name="wt_mgdp_save_settings_btn" id="wt_mgdp_save_settings_btn" class="button button-primary" style="float:right;width: 80px;margin: 12px -22px;"><?php esc_html_e('Save', 'wp-migration-duplicator'); ?></button>
