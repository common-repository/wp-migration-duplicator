...
class Wp_Migration_Duplicator_Review_Request
{
    /**
     * config options 
     */
    private $plugin_title               =   "WebToffee WP Backup and Migration";
    private $review_url                 =   "https://wordpress.org/support/plugin/wp-migration-duplicator/reviews/#new-post";  
    private $plugin_prefix              =   "wtmigrator"; /* must be unique name */
    private $activation_hook            =   "wtmigrator_activate"; /* hook for activation, to store activated date */
    private $deactivation_hook          =   "wtmigrator_deactivate"; /* hook for deactivation, to delete activated date */
    private $days_to_show_banner        =   4; /* when did the banner to show */
    private $remind_days                =   2; /* remind interval in days */
    private $webtoffee_logo_url         =   '/admin/images/webtoffee-logo_small.png';
...
new Wp_Migration_Duplicator_Review_Request();
